...
def main():
    ...
    parser.add_argument("--conf_regex", default=".*20[12][0-9]", help="Regex to filter conference-years")
    parser.add_argument("--output", default=None, help="Output JSON file for retention data")
