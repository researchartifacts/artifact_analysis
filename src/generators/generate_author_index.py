...
def main():
    parser = argparse.ArgumentParser(description="Generate and maintain the canonical author index.")
    parser.add_argument("--data_dir", required=True, help="Website repo root directory (reads/writes assets/data/)")
