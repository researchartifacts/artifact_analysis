...
def _generate_committee_charts(summary, detail, output_dir, inst_timeline=None):
    ...
    _chart_top_countries(detail, os.path.join(charts_dir, "committee_countries_systems.svg"), area="systems")
    _chart_top_countries(detail, os.path.join(charts_dir, "committee_countries_security.svg"), area="security")
    _chart_continents(detail, os.path.join(charts_dir, "committee_continents.svg"))
    _chart_continents(detail, os.path.join(charts_dir, "committee_continents_systems.svg"), area="systems")
    _chart_continents(detail, os.path.join(charts_dir, "committee_continents_security.svg"), area="security")
    _chart_top_institutions(detail, os.path.join(charts_dir, "committee_institutions.svg"))
    _chart_top_institutions(detail, os.path.join(charts_dir, "committee_institutions_systems.svg"), area="systems")
    _chart_top_institutions(detail, os.path.join(charts_dir, "committee_institutions_security.svg"), area="security")
...
def _chart_continents(detail, path, area=None):
    ...
    wedges, texts, autotexts = ax.pie(
        counts, labels=names, colors=colors, autopct="%1.1f%%", startangle=140, pctdistance=0.85
    )
    for t in autotexts:
        t.set_fontsize(8)
    ax.set_title(title, fontweight="bold")
...
def _chart_continent_timeline(detail, path):
    ...
    continent_order = ["North America", "Europe", "Asia", "South America", "Oceania", "Africa", "Unknown"]
