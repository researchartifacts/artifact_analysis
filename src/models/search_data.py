...
class SearchEntry(BaseModel):
    ...
    paper_url: Optional[str] = Field(default=None, description="Paper DOI or direct link.")
    appendix_url: Optional[str] = Field(default=None, description="Supplementary materials URL.")
    award: Optional[str] = Field(default=None, description="Award designation, if any.")
