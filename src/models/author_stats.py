...
class AuthorCore(BaseModel):
    """Shared fields for author statistics and author profiles.

    Not intended for direct instantiation — serves as a base class for
    :class:`AuthorStats` and :class:`AuthorProfile`.
    """
